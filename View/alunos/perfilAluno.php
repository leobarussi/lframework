<title>ProAcademia | Ficha do aluno</title>
<?php
    //dd($data);
    if (empty($data['aluno']['IMG_PERFIL'])) {
        if ($data['aluno']['SEXO'] == 1) {
            $imgPerfil = '/assets/media/logos/recorted.jpg';
            } else {
            $imgPerfil = '/assets/media/logos/recorted2.jpg';
            }
    } else {
        $imgPerfil = '/assets/users/'.$data['aluno']['IMG_PERFIL'];
    }

    $nomeCompleto = explode(' ', $data['pessoa']['NOME_COMPLETO']);
    $nome = array_shift($nomeCompleto).' '.array_pop($nomeCompleto);

    if(!empty($data['contato']) && is_array($data['contato'])){
        for ($i=0; $i<count($data['contato']); $i++){
            if(!empty($data['contato'][$i]['email'])){
                if(!empty($data['contato'][$i]['etiqueta'])){
                    $arrayEmail[] = array('dadosEmail' => $data['contato'][$i]['etiqueta'].' - '.$data['contato'][$i]['email']);
                }else{
                    $arrayEmail[] = array('dadosEmail' => $data['contato'][$i]['email']);
                }
            }

            if(!empty($data['contato'][$i]['telefone'])){
                if(!empty($data['contato'][$i]['etiqueta'])){
                    $arrayTelefone[] = array('dadosTelefone' => $data['contato'][$i]['etiqueta'].' - '.$data['contato'][$i]['telefone']);
                }else{
                    $arrayTelefone[] = array('dadosTelefone' => $data['contato'][$i]['telefone']);
                }
            }
        }
    }

    foreach($data['mensalidades'] as $value){
        $array[$value['mes']][$value['modalidade']] =$value['sequencia'];
    }

    $indice = explode('-', $data['aluno']['PERCENTUAL']);
//dd($data);
?>

<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content">
    <div class="kt-portlet kt-profile" style="margin-bottom: 20px;">
                ...
                <div class="col-md-12 col-lg-5 col-xl-4">
                    <div class="kt-profile__main">
                        ...
                        <div class="kt-profile__main-info">
                            <div class="kt-profile__main-info-name"><?php echo $nome ?></div>
                            <div class="kt-profile__main-info-position"><?php echo empty($data['pessoa']['APELIDO']) ? ('Sem apelidos') : ($data['pessoa']['APELIDO']); ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4 col-xl-4">
                    <div class="kt-profile__contact">
                        <a href="#" class="kt-profile__contact-item">
                            <span class="kt-profile__contact-item-icon kt-profile__contact-item-icon-whatsup"><i class="fas fa-phone"></i></span>
                            <?php
                                if(isset($arrayTelefone)){
                                    for ($i=0; $i<count($arrayTelefone); $i++){
                                        ?>
                                            <span class="kt-profile__contact-item-text"><?php echo $arrayTelefone[$i]['dadosTelefone'] ?></span>
                                        <?php
                                    }
                                }else{
                                    ?>
                                        <span class="kt-profile__contact-item-text">Nenhum telefone não informado.</span>
                                    <?php
                                }
                            ?>
                        </a>
                        <a href="#" class="kt-profile__contact-item">
                            <span class="kt-profile__contact-item-icon"><i class="fas fa-at"></i></span>
                            <?php
                                if(isset($arrayEmail)){
                                    for ($i=0; $i<count($arrayEmail); $i++){
                                        ?>
                                        <span class="kt-profile__contact-item-text"><?php echo $arrayEmail[$i]['dadosEmail'] ?></span>
                                        <?php
                                    }
                                }else{
                                    ?>
                                    <span class="kt-profile__contact-item-text">Nenhum email informado.</span>
                                    <?php
                                }
                            ?>
                        </a>
                ...
                <div class="col-md-12 col-lg-3 col-xl-4">
                    <div class="kt-profile__stats">
                        <div class="kt-profile__stats-item">
                            <div class="kt-profile__stats-item-label"><i class="fas fa-funnel-dollar" style="color: #45CB9A"></i> <?php echo $indice[1] ?></div>
                            <div class="kt-profile__stats-item-chart">
                                <span>Índice: <?php echo $indice[0] ?></span>
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="kt_tabs_1_1" role="tabpanel">
            <div class="row">
                <div class="col-md-4">
                    <div class="kt-portlet kt-widget-12" style="margin-bottom: 20px;">
                        <div class="kt-portlet__body">
                            <div class="kt-widget-12__body">
                                ...
                                <div class="kt-widget-12__info">
                                    To start a blog, think of a topic about and first brainstorm party is ways to write
                                    details
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="kt-portlet kt-portlet--height-fluid">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">Pagamentos de mensalidade</h3>
                            </div>
                        </div>
                        <div class="kt-portlet__body">
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable" id="tbl_alunos">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php
                                                $novoValorMes = [];
                                                foreach($data['mensalidades'] as $meses){
                                                    if(empty($novoValorMes)){
                                                        $novoValorMes[] = $meses['mes'];
                                                        ?>
                                                            <th><?php echo $meses['mes']?></th>
                                                        <?php
                                                    }else{
                                                        if(!in_array($meses['mes'], $novoValorMes)){
                                                            $novoValorMes[] = $meses['mes'];
                                                        ?>
                                                            <th><?php echo $meses['mes'] ?></th>
                                                        <?php
                                    ...
                                    <tbody>
                                        <?php
                                        $novoValor = [];
                                        foreach($data['mensalidades'] as $linhas){
                                            if(!empty($linhas['modalidade'])) {
                                                if(!in_array($linhas['modalidade'], $novoValor)){
                                                    $novoValor[] = $linhas['modalidade'];
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $linhas['modalidade'] ?></td>
                                                        <?php
                                                        foreach($array as $v){
                                                            if(isset($v[$linhas['modalidade']])){
                                                                ?>
                ...
                <div class="col-md-6  order-lg-1 order-xl-1">
                    <div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
                        <div class="kt-portlet__head">
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-bold" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" data-toggle="tab" href="#formasPag"
                                           href="#formasPag" role="tab" aria-selected="false">
                                            Formas Utilizadas
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_portlet_tabs_1111_2_content"
                                           role="tab" aria-selected="false">
                                            Pagos em dia x Pagos com Atrasos
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="formasPag"
                                     role="tabpanel">
                                    <div class="kt-widget-11">
                                        <div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
                                    </div>
                                    <div class="kt-margin-t-30 kt-align-center">
                                        <a href="#" class="btn btn-brand btn-upper btn-bold kt-align-center">Full
                                            Report</a>
                                    </div>
                                </div>
                                <?php
                                    foreach($data['formasPag'] as $value){
                                        ?>
                                        <div class="chartsFormas" data-desc="<?php echo $value['forma_pagamento']?>" data-value="<?php echo $value['total']; ?>" data-percent="<?php echo str_replace(',', '.', $value['percentual']);?>"></div>
                                        <?php
                                    }

                                    foreach($data['detFormasPag'] as $value){
                                        ?>
                                        <div class="chartsFormasDet" data-desc="<?php echo $value['forma_pagamento']?>" data-mes="<?php echo $value['mes']; ?>" data-percent="<?php echo str_replace(',', '.', $value['percentual']);?>"></div>
                                        <?php
                                    }
                                ?>
                                <div class="tab-pane fade" id="kt_portlet_tabs_1111_2_content" role="tabpanel">
                                    <div class="kt-widget-11">
                                        <div id="atrasos" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto"></div>
                                    </div>
                                    <div class="kt-margin-t-30 kt-align-center">
                                        <a href="#" class="btn btn-brand btn-upper btn-bold kt-align-center">Full
                                            Report</a>
                                ...
                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-bold" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" data-toggle="tab"
                                           href="#kt_portlet_tabs_1_1_content" role="tab" aria-selected="false">
                                            Today
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_portlet_tabs_1_2_content"
                                           role="tab" aria-selected="false">
                                            Week
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_portlet_tabs_1_3_content"
                ...
                <div class="col-lg-4 col-xl-3">
                            ...
                            <ul class="kt-nav kt-nav--bold kt-nav--md-space kt-nav--v3 kt-margin-t-20 kt-margin-b-20 nav nav-tabs"
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link active" data-toggle="tab"
                                       href="#kt_profile_tab_personal_information" role="tab">
                                        ...
                                        <span class="kt-nav__link-badge"><span
                                                    class="kt-badge kt-badge--brand kt-badge--inline">2/4 completed</span></span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" data-toggle="tab" href="#kt_profile_tab_account_information"
                                       role="tab">
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" data-toggle="tab" href="#kt_profile_change_password"
                                       role="tab">
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" data-toggle="tab" href="#kt_profile_email_settings"
                                       role="tab">
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" href="#" role="tab" data-toggle="kt-tooltip"
                                       title="This feature is coming soon!" data-placement="right">
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" href="#" role="tab" data-toggle="kt-tooltip"
                                       title="This feature is coming soon!" data-placement="right">
                                        ...
                                        <span class="kt-nav__link-badge"><span
                                                    class="kt-badge kt-badge--danger">3</span></span>
                                    </a>
                                </li>
                                ...
                                <li class="kt-nav__item">
                                    <a class="kt-nav__link" href="#" role="tab" data-toggle="kt-tooltip"
                                       title="This feature is coming soon!" data-placement="right">
                                        ...
                                        <span class="kt-nav__link-badge"><span
                                                    class="kt-badge kt-badge--warning kt-badge--inline">23 new</span></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="kt-margin-t-30 kt-align-center">
                                <a href="#" class="btn btn-sm btn-brand btn-upper btn-bold kt-align-center">Full
                                    Report</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" value="+45678967456"
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                <div class="row">
                                                    <label class="col-xl-3"></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <h3 class="kt-section__title kt-section__title-sm">Address
                                                            Details:</h3>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">State / Province /
                                                        Region</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Zip / Postal
                                                        Code</label>
                                                    <div class="col-lg-9 col-xl-6">
                        ...
                        <div class="tab-pane fade" id="kt_profile_tab_account_information" role="tabpanel">
                            <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">Account Information
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <button type="button"
                                                                class="btn btn-outline-primary btn-sm kt-margin-t-5 kt-margin-b-5">
                                                ...
                                                <div class="form-group row kt-margin-t-10 kt-margin-b-10">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <button type="button"
                                                                class="btn btn-outline-danger btn-sm kt-margin-t-5 kt-margin-b-5">
                            ...
                            <div class="kt-portlet">
                                ...
                                <form class="kt-form kt-form--label-right">
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                <div class="alert alert-outline-danger fade show kt-margin-t-20 kt-margin-b-40"
                                                     role="alert">
                                                    ...
                                                    <div class="alert-text">Configure user passwords to expire
                                                        ...
                                                        going to expire, or they might inadvertently get locked out of
                                                        the system!
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="kt_profile_email_settings" role="tabpanel">
                            <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">Email Notifications
                                            <small>control when and how often Keen sends emails to you</small>
                                        </h3>
                                    </div>
                                </div>
                                <form class="kt-form kt-form--label-right">
                                            ...
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="kt-checkbox-list">
                                                            <label class="kt-checkbox">
                                                                <input type="checkbox"> News about Keen product and
                                                                feature updates
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-checkbox">
                                                            ...
                                                            <label class="kt-checkbox">
                                                                ...
                                                                Keen on partner products and other services
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-checkbox">
                                                                <input type="checkbox" checked="checked"> Tips on Keen
                                                                business products
                                                                <span></span>
                                                            </label>
                                                        </div>
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-widget-6">
                                ...
                                <div class="kt-widget6__tab tab-content">
                                    <div id="kt_personal_income_quater_15d178f84a7660"
                                         class="tab-pane fade active show">
                                        <div class="kt-widget-6__items">
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-7.jpg" alt=""/>
                                                </div>
                                            ...
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-6.jpg" alt=""/>
                                                </div>
                                                <div class="kt-widget-6__item-info">
                                                    <div class="kt-widget-6__item-title">
                                            ...
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-5.jpg" alt=""/>
                                                </div>
                                                <div class="kt-widget-6__item-info">
                                                    <div class="kt-widget-6__item-title">
                                    ...
                                    <div id="kt_personal_income_quater_25d178f84a7660" class="tab-pane fade">
                                        <div class="kt-widget-6__items">
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-6.jpg" alt=""/>
                                    ...
                                    <div id="kt_personal_income_quater_35d178f84a7660" class="tab-pane fade">
                                        <div class="kt-widget-6__items">
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-5.jpg" alt=""/>
                                            ...
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-4.jpg" alt=""/>
                                                </div>
                                                <div class="kt-widget-6__item-info">
                                                    <div class="kt-widget-6__item-title">
                                                        Tips on How to Write an About me page
                                    ...
                                    <div id="kt_personal_income_quater_45d178f84a7660" class="tab-pane fade">
                                        <div class="kt-widget-6__items">
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-6.jpg" alt=""/>
                                            ...
                                            <div class="kt-widget-6__item">
                                                <div class="kt-widget-6__item-pic">
                                                    <img class="" src="/assets/media/blog/blog-3.jpg" alt=""/>
                                                </div>
                                                <div class="kt-widget-6__item-info">
                                                    <div class="kt-widget-6__item-title">
                                                        Get the point across
                                ...
                                <ul class="kt-widget-6__nav-items nav nav-pills nav-fill" role="tablist">
                                    <li class="kt-widget-6__nav-item nav-item">
                                        <a class="nav-link active show" data-toggle="pill"
                                           href="#kt_personal_income_quater_15d178f84a7660">1</a>
                                    </li>
                                    <li class="kt-widget-6__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="#kt_personal_income_quater_25d178f84a7660">2</a>
                                    </li>
                                    <li class="kt-widget-6__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="#kt_personal_income_quater_35d178f84a7660">3</a>
                                    </li>
                                    <li class="kt-widget-6__nav-item nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           href="#kt_personal_income_quater_45d178f84a7660">4</a>
                                    </li>
                                </ul>
                                <!-- end::Nav pills -->
                            </div>
                ...
                <div class="col-lg-12 col-xl-8">
                    ...
                    <div class="kt-portlet kt-portlet--height-fluid">
                        <div class="kt-portlet__head kt-portlet__head--lg kt-portlet__head--noborder kt-portlet__head--break-sm">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">Recent Orders
                                    <small>32500 total</small>
                                </h3>
                            </div>
                            <div class="kt-portlet__head-toolbar">
            ...
            <div class="row">
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-widget-1">
                                <ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#kt_tabs_19_15d178f84a7767"
                                           role="tab">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_19_25d178f84a7767"
                                           role="tab">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35d178f84a7767"
                                           role="tab">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="kt_tabs_19_15d178f84a7767"
                                         role="tabpanel">
                                                ...
                                                <div class="kt-widget-1__item-progress">
                                                    <div class="progress">
                                                        <div class="progress-bar bg-danger" role="progressbar"
                                                             style="width: 79%;" aria-valuenow="25" aria-valuemin="0"
                                    ...
                                    <div class="tab-pane fade" id="kt_tabs_19_25d178f84a7767" role="tabpanel">
                                        <div class="kt-widget-1__item">
                                            <div class="kt-widget-1__item-info">
                                                <a href="#" class="kt-widget-1__item-title">UI/UX Design</a>
                                                <div class="kt-widget-1__item-desc">Evrything you ever imagine</div>
                                    ...
                                    <div class="tab-pane fade" id="kt_tabs_19_35d178f84a7767" role="tabpanel">
                                        <div class="kt-widget-1__item">
                                            <div class="kt-widget-1__item-info">
                                                <a href="#" class="kt-widget-1__item-title">eCommerce Websites</a>
                                                <div class="kt-widget-1__item-desc">Shops, Fasion wep sites & atc</div>
                            ...
                            <div class="kt-portlet__foot-wrapper">
                                <div class="kt-portlet__foot-info">
                                    <div class="kt-widget-12__members">
                                        <a href="#" class="kt-widget-12__member" data-toggle="kt-tooltip"
                                           data-skin="brand" data-placement="top" title="John Myer">
                                            <img src="/assets/media/users/100_1.jpg" alt="image"/>
                                        </a>
                                        <a href="#" class="kt-widget-12__member" data-toggle="kt-tooltip"
                                           data-skin="brand" data-placement="top" title="Alison Brandy">
                                            <img src="/assets/media/users/100_10.jpg" alt="image"/>
                                        </a>
                                        <a href="#" class="kt-widget-12__member" data-toggle="kt-tooltip"
                                           data-skin="brand" data-placement="top" title="Selina Cranson">
                                            <img src="/assets/media/users/100_11.jpg" alt="image"/>
                                        </a>
                                        <a href="#" class="kt-widget-12__member" data-toggle="kt-tooltip"
                                           data-skin="brand" data-placement="top" title="Luke Walls">
                                            <img src="/assets/media/users/100_2.jpg" alt="image"/>
                                        </a>
                                        <a href="#" class="kt-widget-12__member" data-toggle="kt-tooltip"
                                           data-skin="brand" data-placement="top" title="Micheal York">
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="kt-portlet kt-portlet--height-fluid-half kt-widget ">
                        <div class="kt-portlet__body">
                            <div id="kt-widget-slider-13-1" class="kt-slider carousel slide" data-ride="carousel"
                                 data-interval="8000">
                                <div class="kt-slider__head">
                                    <div class="kt-slider__label">Announcements</div>
                                    <div class="kt-slider__nav">
                                        <a class="kt-slider__nav-prev carousel-control-prev"
                                           href="#kt-widget-slider-13-1" role="button" data-slide="prev">
                                            <i class="fa fa-angle-left"></i>
                                        </a>
                                        <a class="kt-slider__nav-next carousel-control-next"
                                           href="#kt-widget-slider-13-1" role="button" data-slide="next">
                    ...
                    <div class="kt-portlet kt-portlet--height-fluid-half kt-widget-13">
                        <div class="kt-portlet__body">
                            <div id="kt-widget-slider-13-2" class="kt-slider carousel slide" data-ride="carousel"
                                 data-interval="4000">
                                <div class="kt-slider__head">
                                    <div class="kt-slider__label">Projects</div>
                                    <div class="kt-slider__nav">
                                        <a class="kt-slider__nav-prev carousel-control-prev"
                                           href="#kt-widget-slider-13-2" role="button" data-slide="prev">
                                            <i class="fa fa-angle-left"></i>
                                        </a>
                                        <a class="kt-slider__nav-next carousel-control-next"
                                           href="#kt-widget-slider-13-2" role="button" data-slide="next">
                                            <i class="fa fa-angle-right"></i>
                                        </a>
                                    </div>
                                </div>
...
<script src="/Assets/js/files/pages/Students/profileStudent.js"></script>